                  ...
                  ${!chk.passed ? `
                    <div class="shrink-0 pl-2">
                      ${chk.id === 'guest_identity' || chk.id === 'documentation_verified' ? `
                        <button class="btn-resolve-id px-3 py-1.5 rounded-lg bg-primary text-on-primary font-bold text-[11px] hover:bg-primary/90 cursor-pointer flex items-center gap-1">
                          <span class="material-symbols-outlined text-[13px]">document_scanner</span>
                          <span>Extract / Verify ID →</span>
                        </button>
